      ...
      <div className="relative z-10 p-6 space-y-12">
        ...
        <div className="bg-white bg-opacity-35 p-6 rounded-lg shadow-lg font-mono">
          ...
          <div className="text-center">
            <div className="mb-6">
              <p className="text-2xl font-bold text-gray-900">Gulshan Kumar</p>
              <p className="text-xl text-zinc-900">Phone: 6383863473</p>
              <p className="text-xl text-zinc-900">LinkedIn: <a href="https://www.linkedin.com/in/gulshankumar0/" className="text-red-900 underline" target="_blank" rel="noopener noreferrer">click here</a></p>
            </div>
